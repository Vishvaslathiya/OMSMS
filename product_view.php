                                                ...
                                                ?>
                                                        <tr class="odd">
                                                            ...
                                                            <td>
                                                                <?php
                                                                $pid = $row['id'];
                                                                $product_detail = "SELECT SUM(stock) AS total_stock FROM tblproductdetail WHERE pid = '$pid'";
                                                                $product_detail_result = mysqli_query($con, $product_detail);
                                                                $row_product_detail = mysqli_fetch_assoc($product_detail_result);
                                                                if ($row_product_detail['total_stock'] == "") {
                                                                    echo "0";
                                                                } else {
                                                                    echo $row_product_detail['total_stock'];
                                                                }
                                                                ?>
                                                            </td>
                                                            <td>
