                                                        ...
                                                        <table border="1" class="table table-bordered mg-b-0">
                                                            ...
                                                            ?>
                                                                <tr>
                                                                    ...
                                                                    <td><img src="prj_img/<?php echo $row1['Image']; ?>" style="border-radius: 0; padding: 0; margin: 0;" width="120px" height="40px" alt="<?php echo $row1['prdName'] ?>"></td>
                                                                    <td>
                                            ...
                                            <table class="table mb-0">
                                                ...
                                                <form name="submit" method="post">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <select name="status" class="form-control wd-450" required="true">
                                                                    <option name="status" value="Order Confirmed" selected="true">Order
                                                                        Confirmed</option>
                                                        ...
                                                        <tr align="center">
                                                            <td colspan="2"><button type="submit" name="submit" class="btn btn-primary">Update
                                                                    order</button></td>
                                                        </tr>
