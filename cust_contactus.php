...
<body>
    ...
    ?>
        ...
        <div class="container my-24 mx-auto md:px-6">
            ...
            <section class="mb-32">
                <div class="block rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] light:bg-neutral-700">
                    <div class="flex flex-wrap items-center">
                        ...
                        <div class="w-[50%]  mt-6 shrink-0 grow-0 basis-auto lg:w-6/12 xl:w-8/12">
                            <div class="flex flex-wrap px-3 pt-12 pb-12 md:pb-0 lg:pt-0">
                                <div class="mb-12 w-full shrink-0 grow-0 basis-auto px-3 md:w-6/12 md:px-6 lg:w-full xl:w-6/12 xl:px-12">
                                    <div class="flex items-start">
                                        ...
                                        <div class="ml-6 grow">
                                            <p class="mb-2 font-bold light:text-black">
                                                Technical support
                                            </p>
                                ...
                                <div class="mb-12 w-full shrink-0 grow-0 basis-auto px-3 md:w-6/12 md:px-6 lg:w-full xl:mb-0 xl:w-6/12 xl:px-12">
                                    <div class="align-start flex">
                                        ...
                                        <div class="ml-6 grow">
                                            <p class="mb-2 font-bold light:text-black">Press</p>
                                            <p class="text-neutral-500 light:text-neutral-200">
                                                press@example.com
                                            </p>
                                            <p class="text-neutral-500 light:text-neutral-200">
                                ...
                                <div class="w-full  mb-4 mt-10 shrink-0 grow-0 basis-auto px-3 md:w-6/12 md:px-6 lg:w-full xl:w-6/12 xl:px-12">
                                    <div class="align-start flex">
                                        <div class="shrink-0">
                                            <div class="inline-block rounded-md bg-primary-100 p-4 text-primary">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="h-6 w-6">
                                        ...
                                        <div class="ml-6  grow">
                                            <p class="mb-2 font-bold light:text-black">Bug report</p>
                                            <p class="text-neutral-500 light:text-neutral-200">
                                                bugs@example.com
                                            </p>
                                            <p class="text-neutral-500 light:text-neutral-200">
